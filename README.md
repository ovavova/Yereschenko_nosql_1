...
1. У запиті 1 ми фільтруємо виконавців, у яких менше 5 треків. Як зміниться результат, якщо знизити поріг до 1? А що станеться, якщо вибирати виконавців із більш ніж 50 треками? Поясніть результат.
 ...
 - Якщо зменшити поріг кількості треків у виконавців то в топ попадуть ті в кого один трек вистрелив і витіснять відомих артистів в кого багато треків. а якщо більше 50 то буде класика з багатьма популярними піснями як Metallica та Nirvana
...
- Результат не змінився. Жанри що мають мало треків - не танцювальні.

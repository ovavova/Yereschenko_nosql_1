...
- $stdDevPop обчислює відхилення по всій популяції, а $stdDevSamp - по частині популяції - Стандартне відхилення вибірки і використовує формулу з коригуванням Бесселя, де знаменник дорівнює $N - 1$. В прикладі ми обчислювали відхилення по всім даним тож брали $stdDevPop. Для великих обємів можливо можна прискорити взявши статистично значущу випадкову вибірку і обчисливши $stdDevSamp
